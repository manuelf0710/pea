...
class ClientesImportMultiProducto implements ToCollection, WithChunkReading, WithCustomCsvSettings
{
        ...
        foreach ($collection as $row) {
            if ($i > 0) {
                ...
                if (!empty($find)) {
                    ...
                    $find2->producto_repso_id =  $row[14] ?? '';
                    $find2->save();
                    $find2->cedula =  $row[0];
